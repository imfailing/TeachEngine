...
<head>
	...
	<script src="clientmod.js"></script>	
</head>
...
<nav>
	...
	<div id="dialogVideo" title="Видео код семинара <?php echo $id?>">
   ...
   <div id="dialogList" title="Список участников">
...
<script type="text/javascript">
	...
	var dialogList = jQuery("#dialogList");	
	var modeNow = {
		"paintMode": false,
		"lineMode": false,
		"rectangleMode": false,
...
//			jQuery('body').css('overflow','hidden');
	...
	$(document).ready(function(){
				...
				$('#sound-trigger').click(function(){
					...
					var flashvars = { streamer:'rtmp://192.168.1.200/flvplayback/',file:'<?php echo $id?>',autostart:'false',bufferlength:'0' };  var params = { allowfullscreen:'false', allowscriptaccess:'always' };
	...
	xhr.onload = function (e) {
		socket.emit('add task', {sessionid: room, filename: e.currentTarget.responseText, ip: $('#ip').val(), nametask: $('#nametask').val(), key: $('#keyword').is(':checked')});
	}
